...
export const rav4: Vehicle = {
  ...
  media: {
    hero: { url: "/images/campaign/rav4.jpg", alt: "Silver Toyota RAV4 on a mountain highway at dusk" },
    gallery: [
      { url: "/images/campaign/rav4.jpg", alt: "Silver Toyota RAV4 on a mountain highway at dusk" },
      { url: "/renders/rav4-2024/rendered-rav4-viewport.png", alt: "2024 Toyota RAV4 Limited, captured 3D viewport render from this showroom" },
    ],
    thumbnails: [{ url: "/images/campaign/rav4.jpg", alt: "Toyota RAV4 thumbnail" }],
    videos: [],
    environmentMaps: [],
  },
