...
export const camry: Vehicle = {
  ...
  media: {
    hero: { url: "/images/campaign/camry.jpg", alt: "Silver Toyota Camry on a mountain highway at dusk" },
    gallery: [{ url: "/images/campaign/camry.jpg", alt: "Silver Toyota Camry on a mountain highway at dusk" }],
    thumbnails: [{ url: "/images/campaign/camry.jpg", alt: "Toyota Camry thumbnail" }],
    videos: [],
    environmentMaps: [],
  },
