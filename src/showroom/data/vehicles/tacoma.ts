...
export const tacoma: Vehicle = {
  ...
  media: {
    hero: { url: "/images/campaign/tacoma.jpg", alt: "Silver Toyota Tacoma on a mountain highway at dusk" },
    gallery: [{ url: "/images/campaign/tacoma.jpg", alt: "Silver Toyota Tacoma on a mountain highway at dusk" }],
    thumbnails: [{ url: "/images/campaign/tacoma.jpg", alt: "Toyota Tacoma thumbnail" }],
    videos: [],
    environmentMaps: [],
  },
