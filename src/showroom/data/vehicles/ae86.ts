...
export const ae86: Vehicle = {
  ...
  media: {
    // No dedicated AE86 photography is packaged in this catalog. Do not reuse another model's photo.
    hero: { url: "", alt: "1985 Toyota Corolla GT-S (AE86) — photography not packaged in this catalog" },
    gallery: [],
    thumbnails: [],
    videos: [],
    environmentMaps: [],
