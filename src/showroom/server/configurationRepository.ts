...
import { getPostgresConfigurationRepository } from "./pgConfigurationRepository";
 ...
 */
let override: ConfigurationRepository | null = null;

export function setConfigurationRepository(next: ConfigurationRepository): void {
  override = next;
}

export function resolveConfigurationRepository(): ConfigurationRepository {
