...
import { isProceduralPreview, type CustomizationOption } from "@/showroom/types/customization";
import { configurationStore, useConfiguration } from "@/showroom/state/useConfiguration";
