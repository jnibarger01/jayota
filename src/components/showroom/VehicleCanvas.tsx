...
import type { Vehicle3DConfig } from "@/showroom/types/vehicle";
import type { CustomizationOption } from "@/showroom/types/customization";
import { VehicleSceneController } from "@/showroom/three/sceneController";
import { attachToMount, getGltfLoader, instantiateAsset, loadAsset, disposeSubtree } from "@/showroom/three/assets";
import { logHierarchy, verifyNodeContract } from "@/showroom/three/nodes";
import { getSceneMapForVehicle } from "@/showroom/data/sceneMap";
import { pointerToNdc } from "@/showroom/three/picking";
import type { SceneRegistryEntry } from "@/showroom/three/sceneRegistry";
import { buildProceduralAccessories, createProceduralVehicle } from "@/showroom/three/proceduralParts";
import {
  initialProgressiveState,
  reduceProgressiveLoad,
} from "@/showroom/three/progressiveLoad";
import { motionDuration } from "@/showroom/three/motionPreference";
import type { TourStatus } from "@/showroom/three/cinematicTour";
import { CameraController, KEYBOARD_ORBIT_STEP_RADIANS, KEYBOARD_ZOOM_STEP } from "@/showroom/three/cameraController";
import {
  EnvironmentController,
  type Terrain,
  type EnvironmentPreset,
} from "@/showroom/three/environmentController";
import { RenderController } from "@/showroom/three/renderController";
import { installMetricsFlush, recordMetric } from "@/showroom/observability/clientMetrics";
